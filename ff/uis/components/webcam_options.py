...
import ff.choices
from ff import wording
from ff.common_helper import get_first
from ff.uis.components.webcam import get_available_webcam_ids
...
def render() -> None:
	...
	WEBCAM_MODE_RADIO = gradio.Radio(
		...
		choices = ff.choices.webcam_modes,
		value = 'inline'
	)
	WEBCAM_RESOLUTION_DROPDOWN = gradio.Dropdown(
		label = wording.get('uis.webcam_resolution_dropdown'),
		choices = ff.choices.webcam_resolutions,
		value = ff.choices.webcam_resolutions[0]
	)
