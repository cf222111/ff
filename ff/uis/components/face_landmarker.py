...
import ff.choices
from ff import face_landmarker, state_manager, wording
from ff.common_helper import calc_float_step
...
def render() -> None:
	...
	FACE_LANDMARKER_SCORE_SLIDER = gradio.Slider(
		...
		step = calc_float_step(ff.choices.face_landmarker_score_range),
