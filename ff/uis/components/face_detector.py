...
import ff.choices
from ff import face_detector, state_manager, wording
from ff.common_helper import calc_float_step, get_last
...
def render() -> None:
	...
	FACE_DETECTOR_SCORE_SLIDER = gradio.Slider(
		...
		step = calc_float_step(ff.choices.face_detector_score_range),
