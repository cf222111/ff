...
def render() -> None:
	...
	EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ff.choices.execution_queue_count_range),
		minimum = ff.choices.execution_queue_count_range[0],
		maximum = ff.choices.execution_queue_count_range[-1]
	)
