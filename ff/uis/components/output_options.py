...
from ff.types import AudioEncoder, Fps, VideoEncoder, VideoPreset
from ff.uis.core import get_ui_components, register_ui_component
from ff.vision import create_image_resolutions, create_video_resolutions, detect_image_resolution, detect_video_fps, detect_video_resolution, pack_resolution
...
def render() -> None:
	...
	OUTPUT_IMAGE_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ff.choices.output_image_quality_range),
	...
	OUTPUT_AUDIO_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ff.choices.output_audio_quality_range),
	...
	OUTPUT_AUDIO_VOLUME_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ff.choices.output_audio_volume_range),
	...
	OUTPUT_VIDEO_QUALITY_SLIDER = gradio.Slider(
		...
		step = calc_int_step(ff.choices.output_video_quality_range),
