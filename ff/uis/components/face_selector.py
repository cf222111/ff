...
from ff.common_helper import calc_float_step, calc_int_step
from ff.face_analyser import get_many_faces
from ff.face_selector import sort_and_filter_faces
from ff.face_store import clear_reference_faces, clear_static_faces
...
from ff.vision import normalize_frame_color, read_static_image, read_video_frame
	...
	with gradio.Group():
		...
		with gradio.Row():
			...
			FACE_SELECTOR_AGE_RANGE_SLIDER = RangeSlider(
				...
				step = calc_int_step(ff.choices.face_selector_age_range)
			)
	REFERENCE_FACE_DISTANCE_SLIDER = gradio.Slider(
		label = wording.get('uis.reference_face_distance_slider'),
		value = state_manager.get_item('reference_face_distance'),
		step = calc_float_step(ff.choices.reference_face_distance_range),
