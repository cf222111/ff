...
from ff.face_masker import create_occlusion_mask, create_region_mask, create_static_box_mask
from ff.face_selector import find_similar_faces, sort_and_filter_faces, sort_faces_by_order
...
from ff.processors.types import FaceSwapperInputs
from ff.program_helper import find_argument_group
from ff.thread_helper import conditional_thread_semaphore
from ff.types import ApplyStateItem, Args, DownloadScope, Embedding, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from ff.vision import read_image, read_static_image, read_static_images, unpack_resolution, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ff.jobs.job_store.register_step_keys(['face_swapper_model', 'face_swapper_pixel_boost'])
